...
public:
	...
	UPROPERTY(EditAnywhere, Category = ComponentDirectionSettings)
	...
	TArray<FBoneTransform> FabrikBoneTransforms;
	TArray<FBoneTransform> FabrikBoneTransforms_duplicate;
